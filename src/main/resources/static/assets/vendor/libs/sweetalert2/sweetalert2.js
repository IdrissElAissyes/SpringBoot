                ...
                8764: function(t) {
                    t.exports = function() {
                        ...
                        var b = {},
                            ...
                            At = function(t) {
                                var e, n, o, i, r, a, c, u, s, l, d = !!(e = M()) && (e.remove(), ct([document.documentElement, document.body], [C["no-backdrop"], C["toast-shown"], C["has-column"]]), !0);
                                if (yt()) E("SweetAlert2 requires document to initialize");
                                else {
                                    var f = document.createElement("div");
                                    f.className = C.container, d && at(f, C["no-transition"]), tt(f, wt);
                                    ...
                                    p.appendChild(f),
                                        ...
                                        }(p), n = D(), o = ut(n, C.input), i = ut(n, C.file), r = n.querySelector(".".concat(C.range, " input")), a = n.querySelector(".".concat(C.range, " output")), c = ut(n, C.select), u = n.querySelector(".".concat(C.checkbox, " input")), s = ut(n, C.textarea), o.oninput = Ct, i.onchange = Ct, c.onchange = Ct, u.onchange = Ct, s.oninput = Ct, r.oninput = function() {
                                            Ct(), a.value = r.value
                                        }, r.onchange = function() {
                                            Ct(), a.value = r.value
                                        }
                        ...
                        var Ot = {
                            ...
                            jt = function(t) {
                                if (t.input)
                                    ...
                                    } else E("Unexpected type of input! Expected ".concat(Object.keys(_t).join(" | "), ', got "').concat(t.input, '"'))
                            },
                            Mt = function(t, e) {
                                var n = ot(D(), t);
                                if (n)
                        ...
                        var Rt = function(t, e) {
                            ...
                            Kt = function(t, e) {
                                var n = e.showClass || {};
                                t.className = "".concat(C.popup, " ").concat(vt(t) ? n.popup : ""), e.toast ? (at([document.documentElement, document.body], C["toast-shown"]), at(t, C.toast)) : at(t, C.modal), nt(t, e, "popup"), "string" == typeof e.customClass && at(t, e.customClass), e.icon && at(t, C["icon-".concat(e.icon)])
                            },
                            Yt = function(t) {
                                ...
                                (function(t, e) {
                                    ...
                                    function(t, e) {
                                        ...
                                        if (o) {
                                            ...
                                            if (e.icon || e.iconHtml) {
                                                if (e.icon && -1 === Object.keys(A).indexOf(e.icon)) return E('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void dt(o);
                        ...
                        var we = function(t) {
                            ...
                            Ae = function(t, e, n) {
                                var o = M(),
                                    i = Et && gt(e);
                                "function" == typeof n.willClose && n.willClose(e), i ? ke(t, e, o, n.returnFocus, n.didClose) : he(t, o, n.returnFocus, n.didClose)
                            },
                            ...
                            Be = function(t) {
                                ...
                                if (e || new ro, e = D()) {
                                    var n = K();
                                    Q() ? dt(q()) : Ee(e, t), lt(n), e.setAttribute("data-loading", "true"), e.setAttribute("aria-busy", "true"), e.focus()
                                }
                            },
                            Ee = function(t, e) {
                                var n = Y(),
                            ...
                            Le = function(t, e) {
                                ...
                                n && (dt(n), L(e.inputValue).then((function(o) {
                                    ...
                                    E("Error in inputValue promise: ".concat(e)), n.value = "", lt(n), n.focus(), t.hideLoading()
                                })))
                            };
                        var je = function t(e) {
                                var n = [];
                            ...
                            He = function(t, e) {
                                ...
                                } else E('The "input" parameter is needed to be set when using returnInputValueOn'.concat(P(e)))
                            },
                            De = function(t, e, n) {
                                var o = Ot.innerParams.get(t);
                        ...
                        var xn, Tn = function(t) {
                            ...
                            Sn = Object.freeze({
                                ...
                                bindClickHandler: function() {
                                    En[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this, Bn || (document.body.addEventListener("click", Tn), Bn = !0)
                                },
                            ...
                            $n = function() {
                                function t() {
                                    if (i(this, t), g(this, Zn, {
                                        ...
                                        this.params = r, this.isAwaitingPromise = !1, v(this, Zn, this._main(xn.params))
                                    }
                                }
                                return a(t, [{
                                    key: "_main",
